...
export const CITIES: City[] = [
  ...
  { id: 'zhen-su', name: 'Zhen-Su', nameAr: 'شن سو', x: 900, y: 300, description: 'Eastern peaks.' },
  { id: 'hyperboria', name: 'Amber Road Station', nameAr: 'طريق العنبر', x: 200, y: 100, description: 'Frozen cradle.' },
  { id: 'zanzibar-sub', name: 'Zanzibar', nameAr: 'زنجبار', x: 600, y: 850, description: 'Spice islands.' },
  { id: 'occidens', name: 'Occidens', nameAr: 'أوكسيدنز', x: 100, y: 600, description: 'Western ports.' }
];
...
export const ROUTES: Route[] = [
  { 
    id: 'silk-road', 
    name: 'Silk Road', 
    path: 'M 900 300 Q 750 350 500 500', 
    color: '#D4AF37', 
    type: 'land' 
  },
  { 
    id: 'amber-road', 
    name: 'Amber Road', 
    path: 'M 200 100 Q 300 350 500 500', 
    color: '#B45309', 
    type: 'land' 
  },
  { 
    ...
    path: 'M 600 850 Q 550 700 500 500', 
    color: '#1E40AF', 
    type: 'sea' 
  }
];
